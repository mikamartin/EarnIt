 ...
 *
 * Marks onboarding as already seen: Home hosts the onboarding tutorial beat itself whenever it
 * isn't, and resetToDefaults() would otherwise leave every test starting on that in-Home tutorial
 * instead of on a fully settled Home screen. OnboardingFlowUiTest explicitly reverses this via
 * resetOnboardingFlag() to test the real first-launch flow.
 */
fun resetAppState() {
    val entryPoint =
